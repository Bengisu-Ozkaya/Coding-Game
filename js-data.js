  ...
  js_1: [
    {
      ...
      prompt: "Konsola 'Merhaba JavaScript!' mesajını yazdıran kodu çalıştırabilir misin?",
    ...
    },
    {
      ...
      prompt: "'yas' adında bir değişken tanımlayıp değerine 22 atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Değeri sonradan değiştirilemeyen 'sehir' adında bir sabit oluşturup değerine 'İstanbul' atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Mevcut 'puan' değişkeninin değerini 100 olarak güncelleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "'isim' ('Ali') ve 'puan' (90) değişkenlerini tanımlayıp her ikisini birlikte konsola yazdırabilir misin?",
  ...
  js_2: [
    {
      ...
      prompt: "'Kodlama' metninin veri tipini konsola yazdırabilir misin?",
    ...
    },
    {
      ...
      prompt: "'42' metin ifadesini sayı türüne dönüştürerek 'sayi' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "5 ile 5 değerlerinin katı (tür ve değer) eşitlik sonucunu 'esitMi' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "'yas' 18 veya üzeri ise VE 'ehliyetVar' doğruysa koşulunu 'surebilirMi' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "17'nin 5'e bölümünden kalan (mod) sonucunu 'kalan' değişkenine atayabilir misin?",
  ...
  js_3: [
    {
      ...
      prompt: "Eğer 'sayi' değişkeni 0'dan büyükse konsola 'Pozitif' yazdıran bir if koşul bloğu kurabilir misin?",
    ...
    },
    {
      ...
      prompt: "'yas' 18 veya üzeri ise konsola 'Reşit', değilse 'Reşit Değil' yazdıran bir if/else bloğu yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "'notu' 85 ve üzeri ise 'Pekiyi', 50 ve üzeri ise 'Geçti' yazdıran kademeli else if koşulunu ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "'puan' 50 ve üzeri ise 'Başarılı', değilse 'Başarısız' üreten tek satırlık koşul (ternary) ifadesini 'sonuc' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "'gun' değişkenini kontrol eden switch bloğu içine 1 durumunda konsola 'Pazartesi' yazdıran case adımını ekleyebilir misin?",
  ...
  js_4: [
    {
      ...
      prompt: "1'den 5'e kadar olan sayıları sırasıyla konsola yazdıran bir for döngüsü kurabilir misin?",
    ...
    },
    {
      ...
      prompt: "'sayac' 3'ten küçük olduğu sürece çalışan ve her adımda sayacı bir artıran bir while döngüsü yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Döngü içinde sayaç 3'e ulaştığında döngüyü tamamen sonlandıran kesme (break) kontrolünü ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Döngüde sayaç 2 olduğunda o adımı atlayıp bir sonraki adıma geçen pas geçme (continue) kontrolünü yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Döngü boyunca sayaç değerlerini 'toplam' değişkenine ekleyerek kümülatif toplamı hesaplayabilir misin?",
  ...
  js_5: [
    {
      ...
      prompt: "Konsola 'Merhaba Dünya' yazdıran 'selamla' adında parametresiz bir fonksiyon tanımlayabilir misin?",
    ...
    },
    {
      ...
      prompt: "İki sayı parametresi (a ve b) alıp toplamlarını geri döndüren 'topla' fonksiyonunu yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Verilen bir sayının karesini geri döndüren tek satırlık ok fonksiyonunu (arrow function) 'kareAl' adıyla tanımlayabilir misin?",
    ...
    },
    {
      ...
      prompt: "'isim' parametresine varsayılan olarak 'Misafir' atayan ve selamlama metni dönen 'hosgeldin' fonksiyonunu yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "'topla' fonksiyonunu 15 ve 25 argümanlarıyla çağırıp dönen sonucu 'toplamSonuc' değişkenine kaydedebilir misin?",
  ...
  js_6: [
    {
      ...
      prompt: "'Elma', 'Muz' ve 'Çilek' elemanlarını içeren 'meyveler' dizisini oluşturup ilk elemanını konsola yazdırabilir misin?",
    ...
    },
    {
      ...
      prompt: "Diziye sonradan 'Mavi' elemanını ekleyen dizi metodunu çalıştırabilir misin?",
    ...
    },
    {
      ...
      prompt: "'sayilar' dizisinin sonundaki elemanı diziden çıkaran çıkarma metodunu çağırabilir misin?",
    ...
    },
    {
      ...
      prompt: "'diller' dizisinin 'JavaScript' elemanını içerip içermediğini kontrol eden sorguyu 'varMi' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "'ogrenciler' dizisindeki toplam eleman sayısını 'toplamOgrenci' değişkenine atayabilir misin?",
  ...
  js_7: [
    {
      ...
      prompt: "'sayilar' dizisindeki her bir elemanı forEach döngüsü ile konsola yazdırabilir misin?",
      presetCode: "let sayilar = [10, 20, 30];\n// forEach ile yazdır:\n",
      filename: "app.js",
      lang: "JavaScript ES6",
    ...
    },
    {
      ...
      prompt: "'sayilar' dizisindeki tüm elemanları map metodu ile 2 ile çarpıp yeni diziyi 'ikiKati' değişkenine kaydedebilir misin?",
    ...
    },
    {
      ...
      prompt: "Dizideki sayıların yalnızca çift olanlarını filter metodu ile süzüp 'ciftler' dizisine aktarabilir misin?",
    ...
    },
    {
      ...
      prompt: "'yaslar' dizisinde 18 ve üzeri olan ilk elemanı find metodu ile bulup 'yetiskin' değişkenine kaydedebilir misin?",
    ...
    },
    {
      ...
      prompt: "'sayilar' dizisindeki tüm elemanların kümülatif toplamını reduce metodu ile hesaplayıp 'toplam' değişkenine atayabilir misin?",
  ...
  js_8: [
    {
      ...
      prompt: "İçinde 'ad' ('Bengi') ve 'yas' (22) özellikleri bulunan 'kullanici' nesnesini oluşturup ad özelliğini konsola yazdırabilir misin?",
    ...
    },
    {
      ...
      prompt: "Aşağıdaki araba nesnesine markayı ve modeli birleştirip dönen 'bilgiVer' metodunu ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Nesne parçalama (destructuring) yöntemiyle 'kitap' nesnesinden 'baslik' ve 'yazar' değişkenlerini tek satırda çıkarabilir misin?",
    ...
    },
    {
      ...
      prompt: "'urun' nesnesinin tüm anahtar isimlerini Object.keys ile alıp 'anahtarlar' dizisine kaydedebilir misin?",
    ...
    },
    {
      ...
      prompt: "Yayma operatörü (...spread) kullanarak mevcut kullanıcı bilgilerine rol özelliği ekleyen yeni bir nesne üretebilir misin?",
  ...
  js_9: [
    {
      ...
      prompt: "Şablon dizgisi (template literal) kullanarak 'ad' ve 'skor' değişkenlerini dinamik metin içinde birleştirip 'mesaj' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Metnin başındaki ve sonundaki boşlukları temizleyip harfleri büyük harfe dönüştüren metodları zincirleme uygulayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Virgülle ayrılmış metni split metodu ile parçalara bölüp 'dizi' değişkenine aktarabilir misin?",
    ...
    },
    {
      ...
      prompt: "7.8 ondalıklı sayısını aşağı tam sayıya yuvarlayan Math metodunu 'yuvarlanan' değişkenine kaydedebilir misin?",
    ...
    },
    {
      ...
      prompt: "1 ile 10 arasında rastgele bir tam sayı üreten matematiksel ifadeyi 'rastgele' değişkenine atayabilir misin?",
  ...
  js_10: [
    {
      ...
      prompt: "Sayfadaki 'ana-baslik' id'li başlık elemanını DOM üzerinden getElementById ile seçip 'baslikEl' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "'.kart-kutusu' sınıfına sahip elemanı querySelector ile seçip 'kart' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Başlık elemanının metin içeriğini (textContent) 'Yeni Başlık' olarak güncelleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kutu elemanının içerisine innerHTML kullanarak kalın vurgulu 'Önemli' metnini ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Form giriş kutusuna (input) girilen güncel değeri okuyup 'girilenMetin' değişkenine aktarabilir misin?",
  ...
  js_11: [
    {
      ...
      prompt: "Kutu elemanının yazı rengini (style üzerinden) kırmızı yapabilir misin?",
    ...
    },
    {
      ...
      prompt: "Kutu elemanının arka plan rengini sarı yapabilir misin?",
    ...
    },
    {
      ...
      prompt: "Buton elemanının sınıf listesine (classList) 'aktif' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Modal elemanının sınıf listesinden 'gizli' sınıfını kaldırabilir misin?",
    ...
    },
    {
      ...
      prompt: "Kart elemanında 'secili' sınıfını varsa kaldıran, yoksa ekleyen (toggle) metodu uygulayabilir misin?",
  ...
  js_12: [
    {
      ...
      prompt: "Butona tıklandığında (click) konsola 'Tıklandı!' yazdıran olay dinleyicisini (addEventListener) ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Form gönderim olayında (submit) sayfanın yeniden yüklenmesini önleyen varsayılanı engelleme metodunu çağırabilir misin?",
    ...
    },
    {
      ...
      prompt: "Giriş kutusuna yazı yazıldığında (input) anlık olarak girilen değeri konsola yazdıran dinleyiciyi ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Olay fonksiyonu içinde tetiklenen hedef elemana (e.target) 'secildi' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Klavye olayında basılan tuşun 'Enter' olup olmadığını kontrol eden koşulu keydown dinleyicisine ekleyebilir misin?",
  ...
  js_13: [
    {
      ...
      prompt: "DOM üzerinde yeni bir liste elemanı (li) oluşturup 'yeniLi' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Üretilen yeni elemanı mevcut listenin sonuna çocuk olarak ekleyen (appendChild) metodu çalıştırabilir misin?",
    ...
    },
    {
      ...
      prompt: "Hedef DOM elemanını sayfadan tamamen kaldıran (remove) metodu yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Üretilen yeni kutuyu kapsayıcının en başına ilk çocuk olarak ekleyen (prepend) metodu yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Tıklanan butonun bir üst ebeveyn elemanını (parentElement) sayfadan kaldıran kodu yazabilir misin?",
  ...
  js_14: [
    {
      ...
      prompt: "Tarayıcı yerel hafızasına (localStorage) 'kullaniciAdi' anahtarıyla 'Bengi' değerini kaydedebilir misin?",
    ...
    },
    {
      ...
      prompt: "Yerel hafızadan 'kullaniciAdi' kaydını okuyup 'kayitliKullanici' değişkenine atayabilir misin?",
    ...
    },
    {
      ...
      prompt: "'gorevler' dizisini JSON metnine dönüştürerek yerel hafızaya kaydedebilir misin?",
    ...
    },
    {
      ...
      prompt: "Yerel hafızadan okunan JSON metnini ayrıştırıp (parse) 'liste' değişkenine aktarabilir misin?",
    ...
    },
    {
      ...
      prompt: "Yerel hafızadan 'kullaniciAdi' kaydını silen metodu çağırabilir misin?",
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { JS_TOPIC_REVIEWS, JS_CHALLENGES };
}
