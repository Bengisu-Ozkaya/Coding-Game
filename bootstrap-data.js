  ...
  bs_1: [
    {
      ...
      prompt: "Kapsayıcı bir div etiketine 'container' sınıfını verip içine 'Hoş Geldiniz' birinci seviye başlığını (h1) yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Ekranın tüm genişliğini kaplaması için div etiketine tam akışkan kapsayıcı sınıfını ('container-fluid') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Sayfaya 'bootstrap.min.css' stil dosyasını bağlayan link etiketini yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "h2 başlık etiketine metni yatayda ortalayacak Bootstrap sınıfını ('text-center') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Hem 'container' hem de 'text-center' sınıflarına sahip bir div oluşturup içerisine 'Hazırız!' paragrafını yerleştirebilir misin?",
  ...
  bs_2: [
    {
      ...
      prompt: "Sütunları nizami bir satırda toplamak için kapsayıcı div etiketine Bootstrap satır sınıfını ('row') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Yan yana 2 eşit sütun oluşturmak için iki div etiketine de 6 birimlik sütun sınıfını ('col-6') verebilir misin?",
    ...
    },
    {
      ...
      prompt: "Orta ve geniş ekranlarda 3 eşit sütun oluşturmak için div etiketine 4 birimlik responsive sütun sınıfını ('col-md-4') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Mobilde tam genişlik (12 birim), geniş ekranda ise yarı genişlik (6 birim) kaplayacak responsive sütun sınıflarını ('col-12 col-lg-6') yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Satır div'ine sütunlar arasında otomatik boşluk bırakacak ızgara boşluğu sınıfını ('g-3') ekleyebilir misin?",
  ...
  bs_3: [
    {
      ...
      prompt: "h1 başlık etiketine gösterişli büyük tipografi görünümü kazandıran 'display-4' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Paragraf etiketine öne çıkan bir giriş/açıklama metni stili kazandıran 'lead' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Paragrafın yazı rengini Bootstrap'in tema mavisi yapacak 'text-primary' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Div etiketine koyu arka plan ve beyaz yazı rengi kazandıran 'bg-dark' ve 'text-white' sınıflarını verebilir misin?",
    ...
    },
    {
      ...
      prompt: "Paragraf etiketini hem sağa yaslayan hem de yeşil yazı rengi veren 'text-end' ve 'text-success' sınıflarını ekleyebilir misin?",
  ...
  bs_4: [
    {
      ...
      prompt: "Div etiketine dört bir taraftan 4 birim iç boşluk ve açık renkli zemin kazandıran 'p-4' ve 'bg-light' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Başlığın alt kısmına 3 birim dış boşluk bırakan 'mb-3' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Div etiketine standart kenarlık, yuvarlatılmış köşeler ve 3 birim iç boşluk veren 'border', 'rounded' ve 'p-3' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kutuya zarif bir derinlik gölgesi, iç boşluk ve beyaz zemin kazandıran 'shadow', 'p-3' ve 'bg-white' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Görsel etiketini tam daire yapan ve hafif gölge veren 'rounded-circle' ve 'shadow-sm' sınıflarını ekleyebilir misin?",
  ...
  bs_5: [
    {
      ...
      prompt: "Buton etiketine Bootstrap'in standart mavi ana buton sınıflarını ('btn' ve 'btn-primary') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Yeşil kenarlıklı şeffaf buton için ilgili butona 'btn' ve 'btn-outline-success' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Butona büyük ve kırmızı tehlike stili kazandıran 'btn', 'btn-danger' ve 'btn-lg' sınıflarını verebilir misin?",
    ...
    },
    {
      ...
      prompt: "İki butonu tek bir bütün grup halinde birleştiren kapsayıcı div etiketine 'btn-group' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Buton içindeki span etiketine kırmızı bir rozet görünümü veren 'badge' ve 'bg-danger' sınıflarını ekleyebilir misin?",
  ...
  bs_6: [
    {
      ...
      prompt: "Div etiketine yeşil renkli başarı bildirim kutusu sınıflarını ('alert' ve 'alert-success') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Uyarı kutusu içine kapatma işlevine sahip kapat butonu ('btn-close' ve data-bs-dismiss='alert') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "İçteki div etiketine %70 doluluk oranında ilerleme çubuğu ('progress-bar') stilini ve genişliğini ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "İlerleme çubuğuna çizgili desen ve hareketli animasyon kazandıran 'progress-bar-striped' ve 'progress-bar-animated' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Sayfaya dönen mavi renkli yükleniyor simgesi ('spinner-border text-primary') div'ini ekleyebilir misin?",
  ...
  bs_7: [
    {
      ...
      prompt: "Tablo etiketine standart Bootstrap tablo stilini ('table') kazandırabilir misin?",
    ...
    },
    {
      ...
      prompt: "Tabloya satırları sırayla çizgili/zebra desenli yapacak 'table' ve 'table-striped' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Tabloya fareyle üzerine gelindiğinde satırı vurgulayan 'table-hover' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "ul etiketine liste grubu sınıfını ('list-group') ve li etiketlerine liste elemanı sınıfını ('list-group-item') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "İlk liste maddesine seçili/aktif olduğunu belirten 'active' sınıfını ekleyebilir misin?",
  ...
  bs_8: [
    {
      ...
      prompt: "Div etiketine Bootstrap kart bileşeni sınıfını ('card') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kartın içerik gövdesini temsil eden içteki div'e 'card-body' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kart başlığına 'card-title' ve kart paragrafına 'card-text' sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Görsel etiketine kartın tepe görseli olduğunu belirten 'card-img-top' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kartın en altına soluk renkli tarih bilgisi barındıran kart altbilgi ('card-footer text-muted') alanını ekleyebilir misin?",
  ...
  bs_9: [
    {
      ...
      prompt: "Metin giriş kutusuna (input) standart Bootstrap form kontrol stilini ('form-control') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Form etiketine (label) Bootstrap form etiket sınıfını ('form-label') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Açılır liste (select) etiketine Bootstrap form seçim stilini ('form-select') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Onay kutusu (checkbox) etiketine Bootstrap seçim kutusu stilini ('form-check-input') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kapsayıcıya giriş grubu ('input-group') ve metin eklentisi span'ine 'input-group-text' sınıflarını ekleyebilir misin?",
  ...
  bs_10: [
    {
      ...
      prompt: "Navigasyon etiketine büyük ekranlarda genişleyen koyu renkli menü çubuğu ('navbar navbar-expand-lg navbar-dark bg-dark') sınıflarını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Logo bağlantısına Bootstrap marka başlığı sınıfını ('navbar-brand') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Menü link etiketine standart menü bağlantı stilini ('nav-link') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Menü linkine aktif sayfada olduğunu belirten 'active' sınıfını ekleyebilir misin?",
      presetCode: "<div class=\"navbar-nav\">\n  <a href=\"#\">Anasayfa</a>\n</div>",
      filename: "index.html",
      lang: "HTML / Bootstrap 5",
    ...
    },
    {
      ...
      prompt: "Mobil menü açma butonunun içine hamburger menü simgesi oluşturan 'navbar-toggler-icon' span'ini ekleyebilir misin?",
  ...
  bs_11: [
    {
      ...
      prompt: "Butona tıklandığında 'ornekModal' modalını açması için gerekli Bootstrap tetikleyici niteliklerini (data-bs-toggle='modal' ve data-bs-target='#ornekModal') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Kapsayıcı div etiketine açılır pencere sınıflarını ve kimliğini ('modal fade' ve id='ornekModal') tanımlayabilir misin?",
    ...
    },
    {
      ...
      prompt: "Modalın gövde içerik alanını oluşturan div'e 'modal-body' sınıfını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Modal içindeki butona tıklandığında pencereyi kapatmasını sağlayan kapatma niteliğini (data-bs-dismiss='modal') ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Açılır kapanır panel oluşturmak için div etiketine 'collapse' sınıfını ve 'detayPanel' kimliğini (id) ekleyebilir misin?",
  ...
  bs_12: [
    {
      ...
      prompt: "Sayfanın en tepesine dikey iç boşluklu, açık gri zeminli ve ortalanmış hero başlık alanını (header, h1) inşa edebilir misin?",
    ...
    },
    {
      ...
      prompt: "Aralarında 4 birim boşluk olan bir satır içine responsive 3 eşit sütun (col-md-4) kartı ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "İletişim formunu sayfada yatay ortalamak için 6 birimlik sütun, otomatik kenar boşluğu, iç boşluk ve kenarlık sınıflarını içeren kapsayıcıyı yazabilir misin?",
    ...
    },
    {
      ...
      prompt: "Sayfanın en altına koyu zeminli, beyaz yazılı ve ortalanmış semantik footer alanını ekleyebilir misin?",
    ...
    },
    {
      ...
      prompt: "Sayfanın ortasına büyük, gölgeli ve yeşil renkli bir aksiyon butonu ('btn btn-success btn-lg shadow') içeren yönlendirme alanını ekleyebilir misin?",
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { BS_TOPIC_REVIEWS, BS_CHALLENGES };
}
